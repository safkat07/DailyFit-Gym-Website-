...
export default function Footer() {
  return (
    <div className=" footer flex justify-evenly items-center px-5 py-16 bg-gradient-to-tl from-primary-0 to-secondary-0  text-optional-0 flex-wrap">
      <div>
      ...
      <div className="flex flex-col gap-5 w-[50%] footercont">
        ...
        <p>Privacy Policy | © 2024 DailyFit</p>
      </div>
